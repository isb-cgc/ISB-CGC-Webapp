        ...
        $('#proj_table').DataTable(
            {
                ...
                "columns": [
                    ...
                    {"type": "html", "orderable": false, render: function(data){return '??';}},
                ...
                "createdRow": function (row, data, dataIndex) {
                    ...
                    $(row).find('.seriesview').on('click', function(event){
                        ...
                        if (!($(elem).is('a')) && !($(elem).hasClass('fa-download'))
                            ...
                            updateCasesOrStudiesSelection([$(row)], 'studies')
                    ...
                    $(row).find('.fa-cart-shopping').parent().on('click', function(event){
                        ...
                        ischecked = updateCasesOrStudiesSelection([$(row)], 'studies', false, rowsAdded)
        ...
        $(rowA).each(function () {
            if (type === 'cases') {
                ...
                if (viewUpdate) {
                    ...
                    window.selProjects[projid].selCases[caseid]['state']['checked'] = (window.selProjects[projid].selCases[caseid]['state']['checked'] ? false : true);
                ...
                if (viewUpdate) {
                    ...
                    if (rowsAdded){
                        $(this).find('.fa-shopping-cart').addClass('selected');
                        $(this).find('.fa-shopping-cart').removeClass('unselected');
                        $(this).find('.fa-shopping-cart').removeClass('partselected');
                    }
                    else{
                        $(this).find('.fa-shopping-cart').addClass('unselected');
                        $(this).find('.fa-shopping-cart').removeClass('unselected');
                        $(this).find('.fa-shopping-cart').removeClass('selected');
                    }

                    window.selProjects[projid].selCases[caseid].selStudies[studyid]['state']['checked'] = (window.selProjects[projid].selCases[caseid].selStudies[studyid]['state']['checked'] ? false : true);
