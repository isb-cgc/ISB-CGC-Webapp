...
//
    ...
    // var selected_node_prog_checkbox = $('#node-filter input:checked').map(function(){
    //         var nodeName = this.dataset.nodeName;
    //         var progName = this.dataset.progName;
    //         return { 'node_name': nodeName, 'prog_name': progName };
    //     });
