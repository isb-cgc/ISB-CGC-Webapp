...
function($, d3, d3tip, vizhelpers) {
    ...
    return {
        create_scatterplot: function(svg, data, domain, range, xLabel, yLabel, xParam, yParam, colorBy, legend, width, height, cohort_set) {
            ...
            var yMap = function(d) { if(typeof(d.y) == "number"){return yScale(yVal(d));} else { return 0;}}
            ...
            var xMap = function(d) { if(typeof(d.x) == "number"){return xScale(xVal(d));} else { return 0;}}
