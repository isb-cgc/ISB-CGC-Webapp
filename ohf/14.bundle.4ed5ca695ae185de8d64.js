...
// CONCATENATED MODULE: /Users/george/ohif/Viewers/extensions/dicom-html/src/TypedArrayProp.js
...
// EXTERNAL MODULE: /Users/george/ohif/Viewers/extensions/dicom-html/src/DicomHtmlViewport.css
var src_DicomHtmlViewport = __webpack_require__(1009);

// CONCATENATED MODULE: /Users/george/ohif/Viewers/extensions/dicom-html/src/DicomHtmlViewport.js
...
function getMainData(data) {
  ...
  root.push();
  return /*#__PURE__*/react_default.a.createElement("div", null, root);
}
...
var DicomHtmlViewport_getContentSequence = function getContentSequence(data) {
  ...
  if (header) {
    ...
    root.push( /*#__PURE__*/react_default.a.createElement(HeaderDynamicLevel, {
      key: header
    }, header));
  }
...
function getMainDataItem(key, value) {
  return /*#__PURE__*/react_default.a.createElement("div", {
    key: key
  }, /*#__PURE__*/react_default.a.createElement("b", null, key), ": ", value);
}

var DicomHtmlViewport_DicomHtmlViewport = /*#__PURE__*/function (_Component) {
  _inherits(DicomHtmlViewport, _Component);

  var _super = _createSuper(DicomHtmlViewport);
  ...
  _createClass(DicomHtmlViewport, [{
    ...
    value: function setContentFromByteArray(byteArray) {
      ...
      var content = /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, mainData, contentSequence);
      this.setState({
        content: content
      });
    }
    ...
    value: function render() {
      ...
      }, content, error && /*#__PURE__*/react_default.a.createElement("h2", null, JSON.stringify(error)));
    }
  }]);
...
// CONCATENATED MODULE: /Users/george/ohif/Viewers/extensions/dicom-html/src/ConnectedDicomHtmlViewport.js
...
// CONCATENATED MODULE: /Users/george/ohif/Viewers/extensions/dicom-html/src/OHIFDicomHtmlViewport.js
function OHIFDicomHtmlViewport_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { OHIFDicomHtmlViewport_typeof = function _typeof(obj) { return typeof obj; }; } else { OHIFDicomHtmlViewport_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return OHIFDicomHtmlViewport_typeof(obj); }
...
function OHIFDicomHtmlViewport_createSuper(Derived) { var hasNativeReflectConstruct = OHIFDicomHtmlViewport_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = OHIFDicomHtmlViewport_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = OHIFDicomHtmlViewport_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return OHIFDicomHtmlViewport_possibleConstructorReturn(this, result); }; }
...
function OHIFDicomHtmlViewport_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var OHIFDicomHtmlViewport_OHIFDicomHtmlViewport = /*#__PURE__*/function (_Component) {
  OHIFDicomHtmlViewport_inherits(OHIFDicomHtmlViewport, _Component);

  var _super = OHIFDicomHtmlViewport_createSuper(OHIFDicomHtmlViewport);
  ...
  OHIFDicomHtmlViewport_createClass(OHIFDicomHtmlViewport, [{
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, this.state.byteArray && /*#__PURE__*/react_default.a.createElement(src_ConnectedDicomHtmlViewport, {
        byteArray: this.state.byteArray,
        viewportIndex: this.props.viewportIndex
      }), this.state.error && /*#__PURE__*/react_default.a.createElement("h2", null, JSON.stringify(this.state.error)));
    }
  }]);
