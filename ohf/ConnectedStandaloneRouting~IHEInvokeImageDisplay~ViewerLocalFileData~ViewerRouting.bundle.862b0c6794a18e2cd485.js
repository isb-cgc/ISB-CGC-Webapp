...
// EXTERNAL MODULE: /Users/george/ohif/Viewers/platform/core/src/DICOMSR/index.js + 8 modules
var DICOMSR = __webpack_require__(234);

// EXTERNAL MODULE: /Users/george/ohif/Viewers/platform/core/src/extensions/MODULE_TYPES.js
var MODULE_TYPES = __webpack_require__(554);
...
var connectedComponents_ToolbarRow = __webpack_require__(989);

// EXTERNAL MODULE: ./App.js + 33 modules
var App = __webpack_require__(245);

// EXTERNAL MODULE: /Users/george/ohif/Viewers/node_modules/cornerstone-tools/dist/cornerstoneTools.js
var cornerstoneTools = __webpack_require__(8);
var cornerstoneTools_default = /*#__PURE__*/__webpack_require__.n(cornerstoneTools);

// EXTERNAL MODULE: /Users/george/ohif/Viewers/node_modules/lodash.clonedeep/index.js
...
var ToolbarRow_ToolbarRow = /*#__PURE__*/function (_Component) {
  _inherits(ToolbarRow, _Component);

  var _super = _createSuper(ToolbarRow);
  ...
  _createClass(ToolbarRow, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/react_default.a.createElement(ui_src["s" /* RoundedButtonGroup */], {
        options: this.buttonGroups.left,
        value: this.props.selectedLeftSidePanel || '',
        onValueChanged: onPressLeft
      })), buttonComponents, /*#__PURE__*/react_default.a.createElement(connectedComponents_ConnectedLayoutButton, null), /*#__PURE__*/react_default.a.createElement("div", {
        className: "pull-right m-t-1 rm-x-1",
        style: {
          marginLeft: 'auto'
        }
      }, this.buttonGroups.right.length && /*#__PURE__*/react_default.a.createElement(ui_src["s" /* RoundedButtonGroup */], {
...
function _getCustomButtonComponent(button, activeButtons) {
  ...
  if (isValidComponent) {
    ...
    return /*#__PURE__*/react_default.a.createElement(CustomComponent, {
...
function _getExpandableButtonComponent(button, activeButtons) {
  ...
  return /*#__PURE__*/react_default.a.createElement(ui_src["h" /* ExpandableToolMenu */], {
    key: button.id,
    label: button.label,
    icon: button.icon,
...
function _getDefaultButtonComponent(button, activeButtons) {
  return /*#__PURE__*/react_default.a.createElement(ui_src["G" /* ToolbarButton */], {
    key: button.id,
    label: button.label,
    icon: button.icon,
...
var connectedComponents_ViewerMain = __webpack_require__(990);

// EXTERNAL MODULE: ./components/ViewportGrid/ViewportGrid.css
var ViewportGrid_ViewportGrid = __webpack_require__(991);

// EXTERNAL MODULE: /Users/george/ohif/Viewers/platform/core/src/utils/index.js + 15 modules
var utils = __webpack_require__(126);

// EXTERNAL MODULE: /Users/george/ohif/Viewers/node_modules/react-dnd/dist/esm/index.js + 31 modules
var esm = __webpack_require__(182);

// EXTERNAL MODULE: ./components/ViewportGrid/ViewportPane.css
var ViewportGrid_ViewportPane = __webpack_require__(992);

// CONCATENATED MODULE: ./components/ViewportGrid/ViewportPane.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || ViewportPane_unsupportedIterableToArray(arr, i) || _nonIterableRest(); }

function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function ViewportPane_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ViewportPane_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ViewportPane_arrayLikeToArray(o, minLen); }

function ViewportPane_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
var EmptyViewport = __webpack_require__(993);
...
var ViewportGrid_ViewportGrid_ViewportGrid = function ViewportGrid(props) {
  ...
  var getViewportPanes = function getViewportPanes() {
    return layout.viewports.map(function (layout, viewportIndex) {
      ...
      return /*#__PURE__*/react_default.a.createElement(components_ViewportGrid_ViewportPane, {
...
function _getViewportComponent(viewportData, viewportIndex, children, availablePlugins, pluginName, defaultPluginName) {
  if (viewportData.displaySet) {
    ...
    return /*#__PURE__*/react_default.a.createElement(ViewportComponent, {
  ...
  return /*#__PURE__*/react_default.a.createElement(EmptyViewport_default.a, null);
}

/* harmony default export */ var components_ViewportGrid_ViewportGrid = (ViewportGrid_ViewportGrid_ViewportGrid);
// EXTERNAL MODULE: /Users/george/ohif/Viewers/node_modules/lodash/memoize.js
var memoize = __webpack_require__(572);
...
function ViewerMain_createSuper(Derived) { var hasNativeReflectConstruct = ViewerMain_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = ViewerMain_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = ViewerMain_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return ViewerMain_possibleConstructorReturn(this, result); }; }
...
function ViewerMain_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var ViewerMain_ViewerMain = /*#__PURE__*/function (_Component) {
  ViewerMain_inherits(ViewerMain, _Component);

  var _super = ViewerMain_createSuper(ViewerMain);
  ...
  ViewerMain_createClass(ViewerMain, [{
    ...
    value: function render() {
      ...
      }, this.state.displaySets.length && /*#__PURE__*/react_default.a.createElement(ViewportGrid_ConnectedViewportGrid, {
...
var components_SidePanel = __webpack_require__(994);

// CONCATENATED MODULE: ./components/SidePanel.js
function SidePanel_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { SidePanel_typeof = function _typeof(obj) { return typeof obj; }; } else { SidePanel_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return SidePanel_typeof(obj); }
...
function SidePanel_createSuper(Derived) { var hasNativeReflectConstruct = SidePanel_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = SidePanel_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = SidePanel_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return SidePanel_possibleConstructorReturn(this, result); }; }
...
function SidePanel_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var SidePanel_SidePanel = /*#__PURE__*/function (_Component) {
  ...
  var _super = SidePanel_createSuper(SidePanel);
...
var ErrorBoundaryDialog_ErrorBoundaryDialog = __webpack_require__(995);

// CONCATENATED MODULE: ./components/ErrorBoundaryDialog/ErrorBoundaryDialog.js
function ErrorBoundaryDialog_slicedToArray(arr, i) { return ErrorBoundaryDialog_arrayWithHoles(arr) || ErrorBoundaryDialog_iterableToArrayLimit(arr, i) || ErrorBoundaryDialog_unsupportedIterableToArray(arr, i) || ErrorBoundaryDialog_nonIterableRest(); }

function ErrorBoundaryDialog_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function ErrorBoundaryDialog_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ErrorBoundaryDialog_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ErrorBoundaryDialog_arrayLikeToArray(o, minLen); }

function ErrorBoundaryDialog_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function ErrorBoundaryDialog_iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
var ErrorBoundaryDialog_ErrorBoundaryDialog_ErrorBoundaryDialog = function ErrorBoundaryDialog(_ref) {
  ...
  var handleOnError = function handleOnError(error, componentStack) {
    var ErrorDialog = function ErrorDialog() {
      ...
      }, context, ": ", /*#__PURE__*/react_default.a.createElement("span", null, error.message))), /*#__PURE__*/react_default.a.createElement("button", {
      ...
      }, /*#__PURE__*/react_default.a.createElement(ui_src["j" /* Icon */], {
        name: "chevron-down",
        className: classnames_default()('ErrorBoundaryDialogIcon', {
          opened: open
        })
      }), "Stack Trace"), open && /*#__PURE__*/react_default.a.createElement("pre", null, componentStack));
    };
  ...
  var fallbackComponent = function fallbackComponent() {
    return /*#__PURE__*/react_default.a.createElement("div", {
      className: "ErrorFallback",
      role: "alert"
    }, /*#__PURE__*/react_default.a.createElement("p", null, "Error rendering ", context, ". ", /*#__PURE__*/react_default.a.createElement("br", null), " Check the browser console for more details."));
  };

  return /*#__PURE__*/react_default.a.createElement(ui_src["g" /* ErrorBoundary */], {
...
var connectedComponents_Viewer = __webpack_require__(996);
...
function Viewer_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var Viewer_Viewer = /*#__PURE__*/function (_Component) {
  Viewer_inherits(Viewer, _Component);

  var _super = Viewer_createSuper(Viewer);
  ...
  Viewer_createClass(Viewer, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement(WhiteLabelingContext["a" /* default */].Consumer, null, function (whiteLabeling) {
        return /*#__PURE__*/react_default.a.createElement(UserManagerContext["a" /* default */].Consumer, null, function (userManager) {
          return /*#__PURE__*/react_default.a.createElement(AppContext["c" /* default */].Consumer, null, function (appContext) {
      ...
      }), /*#__PURE__*/react_default.a.createElement(components_ErrorBoundaryDialog, {
        context: "ToolbarRow"
      }, /*#__PURE__*/react_default.a.createElement(connectedComponents_ToolbarRow_0, {
      ...
      }, /*#__PURE__*/react_default.a.createElement(components_SidePanel_0, {
        from: "left",
        isOpen: this.state.isLeftSidePanelOpen
      }, VisiblePanelLeft ? /*#__PURE__*/react_default.a.createElement(VisiblePanelLeft, {
        viewports: this.props.viewports,
        studies: this.props.studies,
        activeIndex: this.props.activeViewportIndex
      }) : /*#__PURE__*/react_default.a.createElement(connectedComponents_ConnectedStudyBrowser, {
        ...
        context: "ViewerMain"
      }, /*#__PURE__*/react_default.a.createElement(connectedComponents_ConnectedViewerMain, {
        studies: this.props.studies,
        isStudyLoaded: this.props.isStudyLoaded
      }))), /*#__PURE__*/react_default.a.createElement(components_ErrorBoundaryDialog, {
      ...
      }, VisiblePanelRight && /*#__PURE__*/react_default.a.createElement(VisiblePanelRight, {
        isOpen: this.state.isRightSidePanelOpen,
        viewports: this.props.viewports,
        studies: this.props.studies,
        activeIndex: this.props.activeViewportIndex
...
function EmptyViewport() {
  ...
  }, /*#__PURE__*/React.createElement("p", null, "Please drag a stack here to view images."));
}
