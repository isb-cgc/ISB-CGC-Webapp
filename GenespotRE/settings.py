...
BASE_URL                = os.environ.get('BASE_URL', 'https://isb-cgc-test.appspot-preview.com')
BASE_API_URL            = os.environ.get('BASE_API_URL', 'https://api-dot-isb-cgc-test.appspot-preview.com')
