...
from projects.models import Program, Project, Attribute, Attribute_Tooltips, DataSource, DataVersion
...
def main():
    ...
    try:
        projects = Project.objects.select_related('program').filter(owner=isb_superuser,active=True,program__is_public=True)
