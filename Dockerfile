...
RUN apt-get -y install build-essential apt-transport-https gnupg
...
# We need to recompile some of the items because of differences in compiler and Python versions
