...
BIGQUERY_CONFIG = {
    ...
    "tables": [
        {
            "table_id": "{}:TCGA_hg19_data_v0.RNAseq_Gene_Expression_UNC_RSEM".format(settings.BIGQUERY_PROJECT_NAME),
            "genomic_build": "hg19",
        ...
        {
            "table_id": "{}:TCGA_hg38_data_v0.RNAseq_Gene_Expression".format(settings.BIGQUERY_PROJECT_NAME),
            "genomic_build": "hg38",
            "platform": "Illumina HiSeq",
        ...
        {
            "table_id": "{}:TARGET_hg38_data_v0.RNAseq_Gene_Expression".format(settings.BIGQUERY_PROJECT_NAME),
            "genomic_build": "hg38",
            "platform": "Illumina HiSeq",
            "gene_label_field": "gene_name",
            "generating_center": "GDC",
