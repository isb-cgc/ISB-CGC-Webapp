    ...
    "tables": [
        {
            ...
            "table_id": "{}:TCGA_hg19_data_v0.Copy_Number_Segment_Masked".format(settings.BIGQUERY_PROJECT_NAME),
        ...
        },
        {
            ...
            "genomic_build": "hg38",
            "value_field": "segment_mean",
            "table_id": "{}:TCGA_hg38_data_v0.Copy_Number_Segment_Masked".format(settings.BIGQUERY_PROJECT_NAME),
            "gene_label_field": "Hugo_Symbol",
