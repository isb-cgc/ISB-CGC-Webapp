...
BIGQUERY_CONFIG = {
    ...
    "tables": [
        {
            "table_id": "{}:TCGA_hg19_data_v0.Protein_Expression".format(settings.BIGQUERY_PROJECT_NAME),
        ...
        {
            "table_id": "{}:TCGA_hg38_data_v0.Protein_Expression".format(settings.BIGQUERY_PROJECT_NAME),
            "gene_label_field": "gene_name",
            "value_field": "protein_expression",
