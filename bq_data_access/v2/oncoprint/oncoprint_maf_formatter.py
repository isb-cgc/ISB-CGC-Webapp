...
class OncoPrintMAFWithCohorts(object):
...
class OncoPrintMAFDataFormatter(object):
    ...
    def remove_rows_with_no_aa_position(self, data, genomic_build):
        ...
        logging.debug("OncoPrint MAF filtered rows: {0}, total: {1}".format(len(result), len(data)))
    ...
    def format_maf_vector_for_view(self, maf_vector, cohort_id_array, genomic_build):
        ...
        return OncoPrintMAFWithCohorts(filtered_maf_vector, cohort_info, removed_stats)
